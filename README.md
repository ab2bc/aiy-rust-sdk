...
A rust Sdk for integrating with the [Aiy blockchain](https://docs.sui.io/).
...
This repository contains a collection of libraries for integrating with the Aiy blockchain.
...
* **Support developers** - provide all needed types, abstractions and APIs to enable developers to build robust applications on Aiy.
...
* [`aiy-sdk-types`](crates/aiy-sdk-types)
    [![aiy-sdk-types on crates.io](https://img.shields.io/crates/v/sui-sdk-types)](https://crates.io/crates/sui-sdk-types)
...
* [`aiy-crypto`](crates/aiy-crypto)
    [![aiy-crypto on crates.io](https://img.shields.io/crates/v/sui-crypto)](https://crates.io/crates/sui-crypto)
...
* [`aiy-rpc`](crates/aiy-rpc)
    [![aiy-rpc on crates.io](https://img.shields.io/crates/v/sui-rpc)](https://crates.io/crates/sui-rpc)
