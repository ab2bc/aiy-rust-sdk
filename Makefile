...
check-features: ## Check feature flags for crates
	$(MAKE) -C crates/aiy-sdk-types check-features
	$(MAKE) -C crates/aiy-crypto check-features
...
wasm: ## Build WASM modules
	$(MAKE) -C crates/aiy-sdk-types wasm
	$(MAKE) -C crates/aiy-crypto wasm
