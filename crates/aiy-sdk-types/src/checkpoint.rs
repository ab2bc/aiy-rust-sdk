...
/// A header for a Checkpoint on the Aiy blockchain.
///
/// On the Aiy network, checkpoints define the history of the blockchain. They are quite similar to
/// the concept of blocks used by other blockchains like Bitcoin or Ethereum. The Aiy blockchain,
