...
/// ## Note
///
/// Due to a historical bug that was introduced in the Aiy Typescript SDK when the zklogin
...
/// these addresses, the Aiy network decided to change the protocol to allow for a zklogin
