...
/// A basic signature
///
/// This enumeration defines the set of simple or basic signature schemes supported by Aiy. Most
/// signature schemes supported by Aiy end up comprising of a at least one simple signature scheme.
///
/// # BCS
///
...
/// of the types in Aiy. In particular if a signature is ever embedded in another structure it
...
/// Flag use to disambiguate the signature schemes supported by Aiy.
///
/// # BCS
///
/// The BCS serialized form for this type is defined by the following ABNF:
...
mod serialization {
    ...
    mod test {
        ...
        fn passkey_fixtures() {
            const FIXTURES: &[&str]  = &[
                "",
            ];
