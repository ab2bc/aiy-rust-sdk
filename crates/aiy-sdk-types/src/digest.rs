...
/// ```
///
/// Due to historical reasons, even though a `Digest` has a fixed-length of 32, Aiy's binary
...
// Unfortunately aiy's binary representation of digests is prefixed with its length meaning its
