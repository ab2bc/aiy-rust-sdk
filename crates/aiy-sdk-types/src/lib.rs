//! Core type definitions for the [Aiy] blockchain.
//!
//! [Aiy] is a next-generation smart contract platform with high throughput, low latency, and an
//! asset-oriented programming model powered by the Move programming language. This crate provides
//! type definitions for working with the data that makes up the [Aiy] blockchain.
//!
//! [Aiy]: https://sui.io
//!
//! # Feature flags
...
//! extensively throughout the Aiy ecosystem. In particular the BCS format is leveraged because it
...
//! that the network produces. The one caveat to this would be that as the Aiy protocol evolves,
...
//! new variants and types as they are released to Aiy's `testnet` network.
//!
