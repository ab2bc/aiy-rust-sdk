...
use error::Error;
use aiy_types::Address;
use aiy_types::Argument;
use aiy_types::Command;
use aiy_types::GasPayment;
use aiy_types::Identifier;
use aiy_types::Input;
use aiy_types::MakeMoveVector;
use aiy_types::MergeCoins;
use aiy_types::MoveCall;
use aiy_types::ObjectReference;
use aiy_types::Publish;
use aiy_types::SplitCoins;
use aiy_types::Transaction;
use aiy_types::TransactionExpiration;
use aiy_types::TransferObjects;
use aiy_types::TypeTag;
use aiy_types::Upgrade;
...
impl TransactionBuilder {
    ...
    pub fn finish(self) -> Result<Transaction, Error> {
        ...
        Ok(Transaction {
            kind: aiy_types::TransactionKind::ProgrammableTransaction(
                aiy_types::ProgrammableTransaction {
                    inputs: self
                        .inputs
                        .into_iter()
...
//     use aiy_crypto::ed25519::Ed25519PrivateKey;
//     use aiy_crypto::AiySigner;
//     use aiy_graphql_client::faucet::FaucetClient;
//     use aiy_graphql_client::Client;
//     use aiy_graphql_client::PaginationFilter;

//     use aiy_types::framework::Coin;
//     use aiy_types::Address;
//     use aiy_types::Digest;
//     use aiy_types::ExecutionStatus;
//     use aiy_types::IdOperation;
//     use aiy_types::ObjectType;
//     use aiy_types::TransactionEffects;
//     use aiy_types::TypeTag;
...
//     /// Type corresponding to the output of `aiy move build --dump-bytecode-as-base64`
...
//     /// This is used to read the json file that contains the modules/deps/digest generated with aiy
...
//     /// root of the aiy-transaction-builder crate.
...
//         client: &Client,
//         digest: Digest,
//         effects: Result<Option<TransactionEffects>, aiy_graphql_client::error::Error>,
//     ) {
...
//                             match change {
//                                 aiy_types::ObjectOut::PackageWrite { .. } => {
//                                     package_id = Some(obj.object_id);
//                                 }
//                                 aiy_types::ObjectOut::ObjectWrite { .. } => {
...
//                         aiy_types::Owner::Object(_) => {
//                             panic!("Upgrade capability controlled by object")
//                         }
//                         aiy_types::Owner::Immutable => panic!("Upgrade capability is stored immutably and cannot be used for upgrades"),
//                         aiy_types::Owner::ConsensusAddress { .. } => {
//                             upgrade_cap = Some(tx.input(&obj))
//                         }
