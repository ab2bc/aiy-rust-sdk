...
use crate::proto::aiy::rpc::v2::ExecuteTransactionRequest;
use crate::proto::aiy::rpc::v2::ExecuteTransactionResponse;
use crate::proto::aiy::rpc::v2::ExecutionError;
use crate::proto::aiy::rpc::v2::GetEpochRequest;
use crate::proto::aiy::rpc::v2::SubscribeCheckpointsRequest;
...
impl Client {
    ...
    pub async fn execute_transaction_and_wait_for_checkpoint(
        ...
        let executed_txn_digest = match aiy_sdk_types::Transaction::try_from(transaction) {
