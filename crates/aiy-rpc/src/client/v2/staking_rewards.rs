...
use crate::proto::aiy::rpc::v2::simulate_transaction_request::TransactionChecks;
use crate::proto::aiy::rpc::v2::Argument;
use crate::proto::aiy::rpc::v2::GetObjectRequest;
use crate::proto::aiy::rpc::v2::Input;
use crate::proto::aiy::rpc::v2::ListOwnedObjectsRequest;
use crate::proto::aiy::rpc::v2::MoveCall;
use crate::proto::aiy::rpc::v2::Object;
use crate::proto::aiy::rpc::v2::ProgrammableTransaction;
use crate::proto::aiy::rpc::v2::SimulateTransactionRequest;
use crate::proto::aiy::rpc::v2::Transaction;
...
impl Client {
    pub async fn get_delegated_stake(&mut self, staked_aiy_id: &Address) -> Result<DelegatedStake> {
        let maybe_staked_aiy = self
            .ledger_client()
            .get_object(
                GetObjectRequest::new(staked_aiy_id)
    ...
    pub async fn list_delegated_stake(&mut self, address: &Address) -> Result<Vec<DelegatedStake>> {
        ...
        let mut list_request = ListOwnedObjectsRequest::default()
            ...
            .with_read_mask(FieldMask::from_str("contents"))
            .with_object_type(STAKED_AIY_TYPE);
    ...
    async fn calculate_rewards(
        ...
        for id in staked_aiy_ids {
            ...
            ptb.commands.push(
                MoveCall::default()
                    .with_package("0x3")
                    .with_module("aiy_system")
                    .with_function("calculate_rewards")
                    .with_arguments(vec![system_object, staked_aiy])
                    .into(),
            );
        }
        ...
        if staked_aiy_ids.len() != resp.command_outputs.len() {
            return Err(tonic::Status::from_error(
        ...
        for (id, output) in staked_aiy_ids.iter().zip(resp.command_outputs) {
