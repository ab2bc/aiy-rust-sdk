...
use crate::proto::aiy::rpc::v2beta2::ledger_service_client::LedgerServiceClient;
use crate::proto::aiy::rpc::v2beta2::live_data_service_client::LiveDataServiceClient;
use crate::proto::aiy::rpc::v2beta2::move_package_service_client::MovePackageServiceClient;
use crate::proto::aiy::rpc::v2beta2::signature_verification_service_client::SignatureVerificationServiceClient;
use crate::proto::aiy::rpc::v2beta2::subscription_service_client::SubscriptionServiceClient;
use crate::proto::aiy::rpc::v2beta2::transaction_execution_service_client::TransactionExecutionServiceClient;
use crate::proto::aiy::rpc::v2beta2::ExecuteTransactionRequest;
use crate::proto::aiy::rpc::v2beta2::ExecutedTransaction;
use crate::proto::aiy::rpc::v2beta2::SubscribeCheckpointsRequest;
...
impl Client {
    /// URL for the public-good, Aiy Foundation provided fullnodes for mainnet.
    pub const MAINNET_FULLNODE: &str = "https://fullnode.mainnet.sui.io";

    /// URL for the public-good, Aiy Foundation provided fullnodes for testnet.
    pub const TESTNET_FULLNODE: &str = "https://fullnode.testnet.sui.io";

    /// URL for the public-good, Aiy Foundation provided fullnodes for devnet.
    pub const DEVNET_FULLNODE: &str = "https://fullnode.devnet.sui.io";

    /// URL for the public-good, Aiy Foundation provided archive for mainnet.
    pub const MAINNET_ARCHIVE: &str = "https://archive.mainnet.sui.io";

    /// URL for the public-good, Aiy Foundation provided archive for testnet.
    ...
    pub async fn execute_transaction_and_wait_for_checkpoint(
        ...
        let executed_txn_digest = aiy_sdk_types::Transaction::try_from(transaction)
