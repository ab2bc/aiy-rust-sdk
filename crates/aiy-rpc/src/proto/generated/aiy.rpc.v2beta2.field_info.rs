mod _field_impls {
    ...
    impl SimulateTransactionResponseFieldPathBuilder {
        ...
        pub fn outputs(mut self) -> CommandResultFieldPathBuilder {
            self.path.push(SimulateTransactionResponse::OUTPUTS_FIELD.name);
    ...
    impl StakingPool {
        ...
        pub const AIY_BALANCE_FIELD: &'static MessageField = &MessageField {
            name: "aiy_balance",
            json_name: "aiyBalance",
            number: 4i32,
            message_fields: None,
        };
        ...
        pub const PENDING_TOTAL_AIY_WITHDRAW_FIELD: &'static MessageField = &MessageField {
            name: "pending_total_aiy_withdraw",
            json_name: "pendingTotalAiyWithdraw",
            number: 9i32,
            message_fields: None,
        };
    ...
    impl StakingPoolFieldPathBuilder {
        ...
        pub fn aiy_balance(mut self) -> String {
            self.path.push(StakingPool::AIY_BALANCE_FIELD.name);
            self.finish()
        }
        ...
        pub fn pending_total_aiy_withdraw(mut self) -> String {
            self.path.push(StakingPool::PENDING_TOTAL_AIY_WITHDRAW_FIELD.name);
            self.finish()
        }
    ...
    impl EndOfEpochTransactionKind {
        ...
        pub const DISPLAY_REGISTRY_CREATE_FIELD: &'static MessageField = &MessageField {
            name: "display_registry_create",
            json_name: "displayRegistryCreate",
            number: 207i32,
            message_fields: None,
        };
    }
    impl MessageFields for EndOfEpochTransactionKind {
        const FIELDS: &'static [&'static MessageField] = &[
            ...
            Self::DISPLAY_REGISTRY_CREATE_FIELD,
        ];
    }
    impl EndOfEpochTransactionKind {
    ...
    impl EndOfEpochTransactionKindFieldPathBuilder {
        ...
        pub fn display_registry_create(mut self) -> String {
            self.path
                .push(EndOfEpochTransactionKind::DISPLAY_REGISTRY_CREATE_FIELD.name);
            self.finish()
        }
    }
