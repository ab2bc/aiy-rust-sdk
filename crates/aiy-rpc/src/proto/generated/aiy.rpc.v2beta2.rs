...
pub mod checkpoint_commitment {
    ...
    pub enum CheckpointCommitmentKind {
        ...
        /// comprise the live state of the Aiy blockchain.
        EcmhLiveObjectSet = 1,
...
pub struct Epoch {
    ...
    /// Snapshot of Aiy's SystemState (`0x3::aiy_system::SystemState`) at the
...
pub struct ExecutedTransaction {
    ...
    /// `aiy.types.TransactionEffects.events_digest` is populated if the
...
pub mod execution_error {
    ...
    pub enum ExecutionErrorKind {
        ...
        AiyMoveVerificationTimedout = 31,
    ...
    impl ExecutionErrorKind {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::AiyMoveVerificationError => "AIY_MOVE_VERIFICATION_ERROR",
                ...
                Self::AiyMoveVerificationTimedout => "AIY_MOVE_VERIFICATION_TIMEDOUT",
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "AIY_MOVE_VERIFICATION_ERROR" => Some(Self::AiyMoveVerificationError),
                ...
                "AIY_MOVE_VERIFICATION_TIMEDOUT" => {
                    Some(Self::AiyMoveVerificationTimedout)
                }
                "CONSENSUS_OBJECT_OPERATION_NOT_ALLOWED" => {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.LedgerService/GetServiceInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("aiy.rpc.v2beta2.LedgerService", "GetServiceInfo"),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.LedgerService/GetObject",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aiy.rpc.v2beta2.LedgerService", "GetObject"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.LedgerService/BatchGetObjects",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("aiy.rpc.v2beta2.LedgerService", "BatchGetObjects"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.LedgerService/GetTransaction",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("aiy.rpc.v2beta2.LedgerService", "GetTransaction"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.LedgerService/BatchGetTransactions",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "aiy.rpc.v2beta2.LedgerService",
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.LedgerService/GetCheckpoint",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("aiy.rpc.v2beta2.LedgerService", "GetCheckpoint"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.LedgerService/GetEpoch",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aiy.rpc.v2beta2.LedgerService", "GetEpoch"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod ledger_service_server {
    ...
    pub const SERVICE_NAME: &str = "aiy.rpc.v2beta2.LedgerService";
...
pub struct CoinMetadata {
    ...
    /// 0x2::aiy::coin_registry::Currency object (when registered with CoinRegistry).
    #[prost(string, optional, tag = "1")]
...
pub struct GetBalanceRequest {
    /// Required. The owner's Aiy address.
    #[prost(string, optional, tag = "1")]
    pub owner: ::core::option::Option<::prost::alloc::string::String>,
    /// Required. The type names for the coin (e.g., 0x2::aiy::AIY).
    #[prost(string, optional, tag = "2")]
    pub coin_type: ::core::option::Option<::prost::alloc::string::String>,
}
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Balance {
    /// The type of the coin (e.g., 0x2::aiy::AIY).
    #[prost(string, optional, tag = "1")]
    pub coin_type: ::core::option::Option<::prost::alloc::string::String>,
...
pub struct ListOwnedObjectsRequest {
    ...
    /// `0x2::coin::Coin<0x2::aiy::AIY>` will only return `Coin<AIY>` objects.
    #[prost(string, optional, tag = "5")]
    pub object_type: ::core::option::Option<::prost::alloc::string::String>,
}
#[non_exhaustive]
...
pub mod live_data_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.LiveDataService/ListDynamicFields",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "aiy.rpc.v2beta2.LiveDataService",
                        "ListDynamicFields",
                    ),
                );
            self.inner.unary(req, path, codec).await
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.LiveDataService/ListOwnedObjects",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.LiveDataService/GetCoinInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("aiy.rpc.v2beta2.LiveDataService", "GetCoinInfo"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.LiveDataService/GetBalance",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("aiy.rpc.v2beta2.LiveDataService", "GetBalance"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.LiveDataService/ListBalances",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("aiy.rpc.v2beta2.LiveDataService", "ListBalances"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.LiveDataService/SimulateTransaction",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod live_data_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aiy.rpc.v2beta2.LiveDataService";
...
pub struct Package {
    ...
    ///
    /// A package's `storage_id` is the Aiy ObjectId of the package on-chain.
...
pub mod move_package_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.MovePackageService/GetPackage",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("aiy.rpc.v2beta2.MovePackageService", "GetPackage"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.MovePackageService/GetDatatype",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("aiy.rpc.v2beta2.MovePackageService", "GetDatatype"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.MovePackageService/GetFunction",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("aiy.rpc.v2beta2.MovePackageService", "GetFunction"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.MovePackageService/ListPackageVersions",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "aiy.rpc.v2beta2.MovePackageService",
                        "ListPackageVersions",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
pub mod move_package_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aiy.rpc.v2beta2.MovePackageService";
...
pub struct LookupNameRequest {
    /// Required. The AiyNS name to lookup.
    ///
    /// Supports both `@name` as well as `name.aiy` formats.
    #[prost(string, optional, tag = "1")]
    pub name: ::core::option::Option<::prost::alloc::string::String>,
}
#[non_exhaustive]
...
pub struct ReverseLookupNameResponse {
    /// The record for the AiyNS name linked to the requested address
    #[prost(message, optional, tag = "1")]
    pub record: ::core::option::Option<NameRecord>,
}
#[non_exhaustive]
...
pub mod name_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.NameService/LookupName",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("aiy.rpc.v2beta2.NameService", "LookupName"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.NameService/ReverseLookupName",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("aiy.rpc.v2beta2.NameService", "ReverseLookupName"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod name_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aiy.rpc.v2beta2.NameService";
...
pub struct Object {
    ...
    /// The amount of AIY to rebate if this object gets deleted.
...
pub mod signature_verification_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.SignatureVerificationService/VerifySignature",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "aiy.rpc.v2beta2.SignatureVerificationService",
                        "VerifySignature",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
pub mod signature_verification_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aiy.rpc.v2beta2.SignatureVerificationService";
...
pub mod subscription_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ///
        /// This API provides a subscription to the checkpoint stream for the Aiy
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.SubscriptionService/SubscribeCheckpoints",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "aiy.rpc.v2beta2.SubscriptionService",
...
pub mod subscription_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aiy.rpc.v2beta2.SubscriptionService";
...
pub struct ValidatorSet {
    ...
    /// Mappings from staking pool's ID to the aiy address of a validator.
    ///
    /// key: address (staking pool Id), value: address (aiy address of the validator)
    #[prost(message, optional, tag = "5")]
    ...
    ///
    /// key: address (aiy address of the validator), value: 0x3::validator_wrapper::ValidatorWrapper
    #[prost(message, optional, tag = "7")]
...
pub struct Validator {
    ...
    #[prost(string, optional, tag = "1")]
    pub name: ::core::option::Option<::prost::alloc::string::String>,
    /// The Aiy Address of the validator. This is the sender that created the Validator object,
...
pub struct StakingPool {
    ...
    /// in the `StakedAiy` object, updated at epoch boundaries.
    #[prost(uint64, optional, tag = "4")]
    pub aiy_balance: ::core::option::Option<u64>,
    ...
    pub pending_total_aiy_withdraw: ::core::option::Option<u64>,
...
pub struct EndOfEpochTransactionKind {
    #[prost(
        ...
        tags = "2, 3, 4, 200, 201, 202, 203, 204, 205, 206, 207"
    )]
...
pub mod transaction_execution_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aiy.rpc.v2beta2.TransactionExecutionService/ExecuteTransaction",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "aiy.rpc.v2beta2.TransactionExecutionService",
                        "ExecuteTransaction",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
pub mod transaction_execution_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aiy.rpc.v2beta2.TransactionExecutionService";
