...
impl From<aiy_sdk_types::ValidatorAggregatedSignature> for ValidatorAggregatedSignature {
    fn from(value: aiy_sdk_types::ValidatorAggregatedSignature) -> Self {
...
impl TryFrom<&ValidatorAggregatedSignature> for aiy_sdk_types::ValidatorAggregatedSignature {
    ...
    fn try_from(value: &ValidatorAggregatedSignature) -> Result<Self, Self::Error> {
        ...
        let signature = value
            ...
            .as_ref()
            .pipe(aiy_sdk_types::Bls12381Signature::from_bytes)
            .map_err(|e| {
                TryFromProtoError::invalid(ValidatorAggregatedSignature::SIGNATURE_FIELD, e)
            })?;
        let bitmap = aiy_sdk_types::Bitmap::deserialize_from(value.bitmap()).map_err(|e| {
...
impl From<aiy_sdk_types::ValidatorCommitteeMember> for ValidatorCommitteeMember {
    fn from(value: aiy_sdk_types::ValidatorCommitteeMember) -> Self {
        Self {
...
impl TryFrom<&ValidatorCommitteeMember> for aiy_sdk_types::ValidatorCommitteeMember {
    type Error = TryFromProtoError;
...
impl From<aiy_sdk_types::ValidatorCommittee> for ValidatorCommittee {
    fn from(value: aiy_sdk_types::ValidatorCommittee) -> Self {
        Self {
            epoch: Some(value.epoch),
...
impl TryFrom<&ValidatorCommittee> for aiy_sdk_types::ValidatorCommittee {
    type Error = TryFromProtoError;
...
impl From<aiy_sdk_types::CircomG1> for CircomG1 {
    fn from(value: aiy_sdk_types::CircomG1) -> Self {
...
impl TryFrom<&CircomG1> for aiy_sdk_types::CircomG1 {
    type Error = TryFromProtoError;
...
impl From<aiy_sdk_types::CircomG2> for CircomG2 {
    fn from(value: aiy_sdk_types::CircomG2) -> Self {
...
impl TryFrom<&CircomG2> for aiy_sdk_types::CircomG2 {
    type Error = TryFromProtoError;
...
impl From<aiy_sdk_types::ZkLoginClaim> for ZkLoginClaim {
    fn from(
        aiy_sdk_types::ZkLoginClaim { value, index_mod_4 }: aiy_sdk_types::ZkLoginClaim,
    ) -> Self {
        Self {
            value: Some(value),
...
impl TryFrom<&ZkLoginClaim> for aiy_sdk_types::ZkLoginClaim {
    type Error = TryFromProtoError;
...
impl From<aiy_sdk_types::ZkLoginProof> for ZkLoginProof {
    fn from(value: aiy_sdk_types::ZkLoginProof) -> Self {
        Self {
            a: Some(value.a.into()),
            b: Some(value.b.into()),
            c: Some(value.c.into()),
...
impl TryFrom<&ZkLoginProof> for aiy_sdk_types::ZkLoginProof {
    type Error = TryFromProtoError;
...
impl From<aiy_sdk_types::ZkLoginInputs> for ZkLoginInputs {
    fn from(value: aiy_sdk_types::ZkLoginInputs) -> Self {
        Self {
...
impl TryFrom<&ZkLoginInputs> for aiy_sdk_types::ZkLoginInputs {
    type Error = TryFromProtoError;
...
impl From<aiy_sdk_types::ZkLoginAuthenticator> for ZkLoginAuthenticator {
    fn from(value: aiy_sdk_types::ZkLoginAuthenticator) -> Self {
...
impl TryFrom<&ZkLoginAuthenticator> for aiy_sdk_types::ZkLoginAuthenticator {
    type Error = TryFromProtoError;
...
impl From<&aiy_sdk_types::ZkLoginPublicIdentifier> for ZkLoginPublicIdentifier {
    fn from(value: &aiy_sdk_types::ZkLoginPublicIdentifier) -> Self {
        Self {
...
impl TryFrom<&ZkLoginPublicIdentifier> for aiy_sdk_types::ZkLoginPublicIdentifier {
    type Error = TryFromProtoError;
...
impl TryFrom<&SignatureScheme> for aiy_sdk_types::SignatureScheme {
    type Error = TryFromProtoError;
...
impl From<aiy_sdk_types::SimpleSignature> for SimpleSignature {
    fn from(value: aiy_sdk_types::SimpleSignature) -> Self {
        let (signature, public_key) = match &value {
            aiy_sdk_types::SimpleSignature::Ed25519 {
                signature,
                public_key,
            } => (signature.as_bytes(), public_key.as_bytes()),
            aiy_sdk_types::SimpleSignature::Secp256k1 {
                signature,
                public_key,
            } => (signature.as_bytes(), public_key.as_bytes()),
            aiy_sdk_types::SimpleSignature::Secp256r1 {
                signature,
                public_key,
            } => (signature.as_bytes(), public_key.as_bytes()),
...
impl TryFrom<&SimpleSignature> for aiy_sdk_types::SimpleSignature {
    type Error = TryFromProtoError;

    fn try_from(value: &SimpleSignature) -> Result<Self, Self::Error> {
        use aiy_sdk_types::Ed25519PublicKey;
        use aiy_sdk_types::Ed25519Signature;
        use aiy_sdk_types::Secp256k1PublicKey;
        use aiy_sdk_types::Secp256k1Signature;
        use aiy_sdk_types::Secp256r1PublicKey;
        use aiy_sdk_types::Secp256r1Signature;
        use SignatureScheme;
...
impl From<aiy_sdk_types::PasskeyAuthenticator> for PasskeyAuthenticator {
    fn from(value: aiy_sdk_types::PasskeyAuthenticator) -> Self {
        Self {
...
impl TryFrom<&PasskeyAuthenticator> for aiy_sdk_types::PasskeyAuthenticator {
    type Error = TryFromProtoError;
...
impl From<&aiy_sdk_types::MultisigMemberPublicKey> for MultisigMemberPublicKey {
    fn from(value: &aiy_sdk_types::MultisigMemberPublicKey) -> Self {
        use aiy_sdk_types::MultisigMemberPublicKey::*;
...
impl TryFrom<&MultisigMemberPublicKey> for aiy_sdk_types::MultisigMemberPublicKey {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &MultisigMemberPublicKey) -> Result<Self, Self::Error> {
        ...
        match value.scheme() {
            ...
            SignatureScheme::Passkey => Self::Passkey(aiy_sdk_types::PasskeyPublicKey::new(
...
impl From<&aiy_sdk_types::MultisigMember> for MultisigMember {
    fn from(value: &aiy_sdk_types::MultisigMember) -> Self {
        Self {
...
impl TryFrom<&MultisigMember> for aiy_sdk_types::MultisigMember {
    type Error = TryFromProtoError;
...
impl From<&aiy_sdk_types::MultisigCommittee> for MultisigCommittee {
    fn from(value: &aiy_sdk_types::MultisigCommittee) -> Self {
        Self {
...
impl TryFrom<&MultisigCommittee> for aiy_sdk_types::MultisigCommittee {
    type Error = TryFromProtoError;
...
impl From<&aiy_sdk_types::MultisigMemberSignature> for MultisigMemberSignature {
    fn from(value: &aiy_sdk_types::MultisigMemberSignature) -> Self {
        use aiy_sdk_types::MultisigMemberSignature::*;
...
impl TryFrom<&MultisigMemberSignature> for aiy_sdk_types::MultisigMemberSignature {
    type Error = TryFromProtoError;
...
impl From<&aiy_sdk_types::MultisigAggregatedSignature> for MultisigAggregatedSignature {
    fn from(value: &aiy_sdk_types::MultisigAggregatedSignature) -> Self {
        Self {
...
impl TryFrom<&MultisigAggregatedSignature> for aiy_sdk_types::MultisigAggregatedSignature {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &MultisigAggregatedSignature) -> Result<Self, Self::Error> {
        ...
        if let Some(legacy_bitmap) = value.legacy_bitmap_opt() {
            let legacy_bitmap =
                aiy_sdk_types::Bitmap::deserialize_from(legacy_bitmap).map_err(|e| {
...
impl From<aiy_sdk_types::UserSignature> for UserSignature {
    fn from(value: aiy_sdk_types::UserSignature) -> Self {
        Self::merge_from(value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<aiy_sdk_types::UserSignature> for UserSignature {
    fn merge(&mut self, source: aiy_sdk_types::UserSignature, mask: &FieldMaskTree) {
        use aiy_sdk_types::UserSignature::*;
...
impl TryFrom<&UserSignature> for aiy_sdk_types::UserSignature {
    type Error = TryFromProtoError;
