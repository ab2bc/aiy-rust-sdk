...
impl From<aiy_sdk_types::Object> for Object {
    fn from(value: aiy_sdk_types::Object) -> Self {
...
impl Merge<aiy_sdk_types::Object> for Object {
    fn merge(&mut self, source: aiy_sdk_types::Object, mask: &FieldMaskTree) {
        if mask.contains(Self::BCS_FIELD.name) {
        ...
        match source.data() {
            aiy_sdk_types::ObjectData::Struct(move_struct) => {
                self.merge(move_struct, mask);
            }
            aiy_sdk_types::ObjectData::Package(move_package) => {
...
impl Merge<&aiy_sdk_types::MoveStruct> for Object {
    fn merge(&mut self, source: &aiy_sdk_types::MoveStruct, mask: &FieldMaskTree) {
        if mask.contains(Self::OBJECT_TYPE_FIELD.name) {
...
impl Merge<&aiy_sdk_types::MovePackage> for Object {
    fn merge(&mut self, source: &aiy_sdk_types::MovePackage, mask: &FieldMaskTree) {
        if mask.contains(Self::OBJECT_TYPE_FIELD.name) {
...
fn try_extract_struct(value: &Object) -> Result<aiy_sdk_types::MoveStruct, TryFromProtoError> {
    let version = value
        .version
    ...
    aiy_sdk_types::MoveStruct::new(object_type, has_public_transfer, version, contents).ok_or_else(
        || TryFromProtoError::invalid(Object::CONTENTS_FIELD, "contents missing object_id"),
    )
}

#[allow(clippy::result_large_err)]
fn try_extract_package(value: &Object) -> Result<aiy_sdk_types::MovePackage, TryFromProtoError> {
...
impl TryFrom<&Object> for aiy_sdk_types::Object {
    ...
    fn try_from(value: &Object) -> Result<Self, Self::Error> {
        ...
        let object_data = if value.object_type() == PACKAGE_TYPE {
            // Package
            aiy_sdk_types::ObjectData::Package(try_extract_package(value)?)
        } else {
            // Struct
            aiy_sdk_types::ObjectData::Struct(try_extract_struct(value)?)
        };
...
impl From<aiy_sdk_types::TypeOrigin> for TypeOrigin {
    fn from(value: aiy_sdk_types::TypeOrigin) -> Self {
        Self {
...
impl TryFrom<&TypeOrigin> for aiy_sdk_types::TypeOrigin {
    type Error = TryFromProtoError;
...
impl From<aiy_sdk_types::GenesisObject> for Object {
    fn from(value: aiy_sdk_types::GenesisObject) -> Self {
...
impl TryFrom<&Object> for aiy_sdk_types::GenesisObject {
    type Error = TryFromProtoError;
...
impl From<aiy_sdk_types::ObjectReference> for ObjectReference {
    fn from(value: aiy_sdk_types::ObjectReference) -> Self {
...
impl TryFrom<&ObjectReference> for aiy_sdk_types::ObjectReference {
    type Error = TryFromProtoError;
...
impl From<aiy_sdk_types::Owner> for Owner {
    fn from(value: aiy_sdk_types::Owner) -> Self {
        use owner::OwnerKind;
        use aiy_sdk_types::Owner::*;
...
impl TryFrom<&Owner> for aiy_sdk_types::Owner {
    type Error = TryFromProtoError;
...
impl ObjectSet {
    ...
    pub fn binary_search<'a>(
        &'a self,
        object_id: &aiy_sdk_types::Address,
        version: u64,
    ) -> Option<&'a Object> {
