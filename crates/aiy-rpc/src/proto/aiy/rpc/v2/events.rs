...
impl From<aiy_sdk_types::Event> for Event {
    fn from(value: aiy_sdk_types::Event) -> Self {
        Self::merge_from(value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<aiy_sdk_types::Event> for Event {
    fn merge(&mut self, source: aiy_sdk_types::Event, mask: &FieldMaskTree) {
...
impl TryFrom<&Event> for aiy_sdk_types::Event {
...
impl From<aiy_sdk_types::TransactionEvents> for TransactionEvents {
    fn from(value: aiy_sdk_types::TransactionEvents) -> Self {
        Self::merge_from(value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<aiy_sdk_types::TransactionEvents> for TransactionEvents {
    fn merge(&mut self, source: aiy_sdk_types::TransactionEvents, mask: &FieldMaskTree) {
...
impl TryFrom<&TransactionEvents> for aiy_sdk_types::TransactionEvents {
    type Error = TryFromProtoError;
