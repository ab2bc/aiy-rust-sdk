...
impl From<aiy_sdk_types::CheckpointSummary> for CheckpointSummary {
    fn from(summary: aiy_sdk_types::CheckpointSummary) -> Self {
        Self::merge_from(summary, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<aiy_sdk_types::CheckpointSummary> for CheckpointSummary {
    fn merge(&mut self, source: aiy_sdk_types::CheckpointSummary, mask: &FieldMaskTree) {
        ...
        let aiy_sdk_types::CheckpointSummary {
            epoch,
            sequence_number,
...
impl TryFrom<&CheckpointSummary> for aiy_sdk_types::CheckpointSummary {
...
impl From<aiy_sdk_types::GasCostSummary> for GasCostSummary {
    fn from(
        aiy_sdk_types::GasCostSummary {
            computation_cost,
            storage_cost,
            storage_rebate,
...
impl TryFrom<&GasCostSummary> for aiy_sdk_types::GasCostSummary {
    type Error = TryFromProtoError;
...
impl From<aiy_sdk_types::CheckpointCommitment> for CheckpointCommitment {
    fn from(value: aiy_sdk_types::CheckpointCommitment) -> Self {
        use checkpoint_commitment::CheckpointCommitmentKind;

        let mut message = Self::default();

        let kind = match value {
            aiy_sdk_types::CheckpointCommitment::EcmhLiveObjectSet { digest } => {
                message.digest = Some(digest.to_string());
                CheckpointCommitmentKind::EcmhLiveObjectSet
            }
            aiy_sdk_types::CheckpointCommitment::CheckpointArtifacts { digest } => {
                message.digest = Some(digest.to_string());
...
impl TryFrom<&CheckpointCommitment> for aiy_sdk_types::CheckpointCommitment {
    type Error = TryFromProtoError;
...
impl From<aiy_sdk_types::EndOfEpochData> for EndOfEpochData {
    fn from(
        aiy_sdk_types::EndOfEpochData {
...
impl TryFrom<&EndOfEpochData> for aiy_sdk_types::EndOfEpochData {
    type Error = TryFromProtoError;
...
impl From<aiy_sdk_types::CheckpointTransactionInfo> for CheckpointedTransactionInfo {
    fn from(value: aiy_sdk_types::CheckpointTransactionInfo) -> Self {
        Self {
...
impl TryFrom<&CheckpointedTransactionInfo> for aiy_sdk_types::CheckpointTransactionInfo {
    type Error = TryFromProtoError;
...
impl From<aiy_sdk_types::CheckpointContents> for CheckpointContents {
    fn from(value: aiy_sdk_types::CheckpointContents) -> Self {
        Self::merge_from(value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<aiy_sdk_types::CheckpointContents> for CheckpointContents {
    fn merge(&mut self, source: aiy_sdk_types::CheckpointContents, mask: &FieldMaskTree) {
        if mask.contains(Self::BCS_FIELD.name) {
            let mut bcs = Bcs::serialize(&source).unwrap();
...
impl TryFrom<&CheckpointContents> for aiy_sdk_types::CheckpointContents {
    type Error = TryFromProtoError;
...
impl Merge<&aiy_sdk_types::CheckpointSummary> for Checkpoint {
    fn merge(&mut self, source: &aiy_sdk_types::CheckpointSummary, mask: &FieldMaskTree) {
        if mask.contains(Self::SEQUENCE_NUMBER_FIELD.name) {
...
impl Merge<aiy_sdk_types::ValidatorAggregatedSignature> for Checkpoint {
    fn merge(&mut self, source: aiy_sdk_types::ValidatorAggregatedSignature, mask: &FieldMaskTree) {
...
impl Merge<aiy_sdk_types::CheckpointContents> for Checkpoint {
    fn merge(&mut self, source: aiy_sdk_types::CheckpointContents, mask: &FieldMaskTree) {
