...
impl From<aiy_sdk_types::BalanceChange> for BalanceChange {
    fn from(value: aiy_sdk_types::BalanceChange) -> Self {
        Self {
...
impl Merge<&aiy_sdk_types::BalanceChange> for BalanceChange {
    fn merge(&mut self, source: &aiy_sdk_types::BalanceChange, mask: &crate::field::FieldMaskTree) {
...
impl TryFrom<&BalanceChange> for aiy_sdk_types::BalanceChange {
