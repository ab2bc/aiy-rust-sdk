...
impl From<aiy_sdk_types::TransactionEffects> for TransactionEffects {
    fn from(value: aiy_sdk_types::TransactionEffects) -> Self {
        Self::merge_from(&value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<&aiy_sdk_types::TransactionEffects> for TransactionEffects {
    fn merge(&mut self, source: &aiy_sdk_types::TransactionEffects, mask: &FieldMaskTree) {
        ...
        match source {
            aiy_sdk_types::TransactionEffects::V1(v1) => self.merge(v1.as_ref(), mask),
            aiy_sdk_types::TransactionEffects::V2(v2) => self.merge(v2.as_ref(), mask),
        }
    }
}
...
impl TryFrom<&TransactionEffects> for aiy_sdk_types::TransactionEffects {
...
impl Merge<&aiy_sdk_types::TransactionEffectsV1> for TransactionEffects {
    fn merge(
        &mut self,
        aiy_sdk_types::TransactionEffectsV1 {
            status,
            epoch,
            gas_used,
...
impl Merge<&aiy_sdk_types::TransactionEffectsV2> for TransactionEffects {
    fn merge(
        &mut self,
        aiy_sdk_types::TransactionEffectsV2 {
            status,
            epoch,
            gas_used,
            transaction_digest,
...
impl From<aiy_sdk_types::ChangedObject> for ChangedObject {
    fn from(value: aiy_sdk_types::ChangedObject) -> Self {
        ...
        let input_state = match value.input_state {
            aiy_sdk_types::ObjectIn::NotExist => InputObjectState::DoesNotExist,
            aiy_sdk_types::ObjectIn::Exist {
                version,
                digest,
                owner,
            } => {
        ...
        let output_state = match value.output_state {
            aiy_sdk_types::ObjectOut::NotExist => OutputObjectState::DoesNotExist,
            aiy_sdk_types::ObjectOut::ObjectWrite { digest, owner } => {
                message.output_digest = Some(digest.to_string());
                message.output_owner = Some(owner.into());
                OutputObjectState::ObjectWrite
            }
            aiy_sdk_types::ObjectOut::PackageWrite { version, digest } => {
...
impl TryFrom<&ChangedObject> for aiy_sdk_types::ChangedObject {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &ChangedObject) -> Result<Self, Self::Error> {
        ...
        let input_state = match value.input_state() {
            ...
            InputObjectState::DoesNotExist => aiy_sdk_types::ObjectIn::NotExist,
            InputObjectState::Exists => aiy_sdk_types::ObjectIn::Exist {
                version: value
                    .input_version
        ...
        let output_state = match value.output_state() {
            ...
            OutputObjectState::DoesNotExist => aiy_sdk_types::ObjectOut::NotExist,
            OutputObjectState::ObjectWrite => aiy_sdk_types::ObjectOut::ObjectWrite {
                digest: value
                    .output_digest
                    .as_ref()
                    .ok_or_else(|| TryFromProtoError::missing("digest"))?
            ...
            OutputObjectState::PackageWrite => aiy_sdk_types::ObjectOut::PackageWrite {
                version: value
                    .output_version
                    .ok_or_else(|| TryFromProtoError::missing("version"))?,
                digest: value
...
impl From<aiy_sdk_types::IdOperation> for changed_object::IdOperation {
    fn from(value: aiy_sdk_types::IdOperation) -> Self {
        use aiy_sdk_types::IdOperation::*;
...
impl TryFrom<changed_object::IdOperation> for aiy_sdk_types::IdOperation {
    type Error = TryFromProtoError;
...
impl From<aiy_sdk_types::UnchangedConsensusObject> for UnchangedConsensusObject {
    fn from(value: aiy_sdk_types::UnchangedConsensusObject) -> Self {
        use aiy_sdk_types::UnchangedConsensusKind::*;
...
impl TryFrom<&UnchangedConsensusObject> for aiy_sdk_types::UnchangedConsensusObject {
    type Error = TryFromProtoError;
