...
impl From<aiy_sdk_types::ExecutionStatus> for ExecutionStatus {
    fn from(value: aiy_sdk_types::ExecutionStatus) -> Self {
        match value {
            aiy_sdk_types::ExecutionStatus::Success => Self {
                success: Some(true),
                error: None,
            },
            aiy_sdk_types::ExecutionStatus::Failure { error, command } => {
...
impl TryFrom<&ExecutionStatus> for aiy_sdk_types::ExecutionStatus {
    ...
    fn try_from(value: &ExecutionStatus) -> Result<Self, Self::Error> {
        ...
        match (success, &value.error) {
            ...
            (false, Some(error)) => Self::Failure {
                error: aiy_sdk_types::ExecutionError::try_from(error)
...
impl From<aiy_sdk_types::ExecutionError> for ExecutionError {
    fn from(value: aiy_sdk_types::ExecutionError) -> Self {
        use execution_error::ErrorDetails;
        use execution_error::ExecutionErrorKind;
        use aiy_sdk_types::ExecutionError as E;
        ...
        let kind = match value {
            ...
            E::AiyMoveVerificationError => ExecutionErrorKind::AiyMoveVerificationError,
            ...
            E::AiyMoveVerificationTimedout => ExecutionErrorKind::AiyMoveVerificationTimedout,
...
impl TryFrom<&ExecutionError> for aiy_sdk_types::ExecutionError {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &ExecutionError) -> Result<Self, Self::Error> {
        ...
        match value.kind() {
            ...
            K::AiyMoveVerificationError => Self::AiyMoveVerificationError,
            ...
            K::AiyMoveVerificationTimedout => Self::AiyMoveVerificationTimedout,
...
impl From<aiy_sdk_types::CommandArgumentError> for CommandArgumentError {
    fn from(value: aiy_sdk_types::CommandArgumentError) -> Self {
        use command_argument_error::CommandArgumentErrorKind;
        use aiy_sdk_types::CommandArgumentError as E;
...
impl TryFrom<&CommandArgumentError> for aiy_sdk_types::CommandArgumentError {
    type Error = TryFromProtoError;
...
impl From<aiy_sdk_types::TypeArgumentError> for type_argument_error::TypeArgumentErrorKind {
    fn from(value: aiy_sdk_types::TypeArgumentError) -> Self {
        use aiy_sdk_types::TypeArgumentError::*;
...
impl TryFrom<type_argument_error::TypeArgumentErrorKind> for aiy_sdk_types::TypeArgumentError {
    type Error = TryFromProtoError;
...
impl From<aiy_sdk_types::PackageUpgradeError> for PackageUpgradeError {
    fn from(value: aiy_sdk_types::PackageUpgradeError) -> Self {
        use package_upgrade_error::PackageUpgradeErrorKind;
        use aiy_sdk_types::PackageUpgradeError as E;
...
impl TryFrom<&PackageUpgradeError> for aiy_sdk_types::PackageUpgradeError {
    type Error = TryFromProtoError;
...
impl From<aiy_sdk_types::MoveLocation> for MoveLocation {
    fn from(value: aiy_sdk_types::MoveLocation) -> Self {
        Self {
...
impl TryFrom<&MoveLocation> for aiy_sdk_types::MoveLocation {
    type Error = TryFromProtoError;
