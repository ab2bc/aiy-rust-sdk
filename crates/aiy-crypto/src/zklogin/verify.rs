...
use aiy_sdk_types::Bn254FieldElement;
use aiy_sdk_types::CircomG1;
use aiy_sdk_types::CircomG2;
use aiy_sdk_types::Ed25519PublicKey;
use aiy_sdk_types::Jwk;
use aiy_sdk_types::Secp256k1PublicKey;
use aiy_sdk_types::Secp256r1PublicKey;
use aiy_sdk_types::SimpleSignature;
use aiy_sdk_types::ZkLoginInputs;
use aiy_sdk_types::ZkLoginProof;
...
/// Calculate the Aiy address based on address seed and address params.
#[allow(unused)]
fn gen_address_seed(
    salt: &str,
    name: &str,  // i.e. "sub"
