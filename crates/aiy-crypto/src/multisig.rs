...
use crate::Verifier;
use aiy_sdk_types::MultisigAggregatedSignature;
use aiy_sdk_types::MultisigCommittee;
...
impl MultisigAggregator {
    pub fn new_with_transaction(
        committee: MultisigCommittee,
        transaction: &aiy_sdk_types::Transaction,
    ) -> Self {
        Self {
            committee,
    ...
    pub fn new_with_message(
        committee: MultisigCommittee,
        message: &aiy_sdk_types::PersonalMessage<'_>,
    ) -> Self {
        Self {
            committee,
            signatures: Default::default(),
